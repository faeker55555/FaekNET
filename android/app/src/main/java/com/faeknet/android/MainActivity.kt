...
class MainActivity : Activity() {
    ...
    private fun field(root: LinearLayout, hint: String, value: String, password: Boolean=false): EditText {
        ...
        return EditText(this).apply { setText(value); textSize=14f; setTextColor(Color.rgb(233,228,223)); setHintTextColor(Color.rgb(120,112,106)); this.hint=hint; if(password) inputType=0x81; root.addView(this, ViewGroup.LayoutParams(-1,-2)) }
    }
